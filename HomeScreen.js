...
import Share, { ShareSheet, Button, Clipboard } from 'react-native-share';
...
export default class HomeScreen extends React.Component {
    ...
    CheckView = () => {
        if(this.state.allLoaded === true){
            ...
            let shareOptions = {
                title: "Brasov Bus",
                message: "Eu folosesc aceasta aplicatie :)",
                url: "https://www.facebook.com/brasovbus/",
                subject: "Brasov Bus" //  for email
            };
            return(
                <View style={{ flex: 1, }}>
                    ...
                    <View style={styles.container4}>
                        <TouchableOpacity onPress={() => navigate('MapTest')} style={styles.buttonOpenModalLine} underlayColor={'transparent'}>
                            <Text style={styles.textOpenModal}>
                                Hartă {" "}
                                <Icon name="map" size={22} color="white" style={{ paddingLeft: 20 }} />
                            </Text>
                        </TouchableOpacity>
                    </View>
                    <View style={styles.buttonShare}>
                        <TouchableOpacity onPress={this.onOpen.bind(this)}
                         underlayColor={'transparent</TouchableOpacity>'}>
                        <Icon name="share-alt" size={20} color="white" />
                        </TouchableOpacity>                        
                    </View>
                    {/* <View style={styles.info}>
                        <TouchableOpacity onPress={() => { }} underlayColor={'transparent</TouchableOpacity>'}>
                            <Icon name="info-circle" size={20} color="white" />
                        </TouchableOpacity>
                    </View> */}
                    {/* <View style={styles.container4}>
                        <TouchableOpacity onPress={() => navigate('AnimatedMarkers')} style={styles.buttonOpenModalLine} underlayColor={'transparent'}>
                            <Text style={styles.textOpenModal}>
                                TEST {" "}
                                <Icon name="heart" size={22} color="white" style={{ paddingLeft: 20 }} />
                            </Text>
