...
export default class Line extends React.Component {
    ...
    pula(){
        console.log("ActiveWeek: " + this.state.activeWeek);
        console.log("ActiveWeekEnd: " + this.state.activeWeekend);
        console.log("Dus: " + this.state.activeGoing);
        console.log("intors: " + this.state.activeReturned);
